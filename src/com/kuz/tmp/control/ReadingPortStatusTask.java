 ...
 */
public class ReadingPortStatusTask extends SwingWorker<Void, Message> implements Observer {

    private volatile boolean finished = false;
    private String portName;
    private ComPort port;
    private Logger logger = Logger.getLogger(ReadingPortStatusTask.class);

    public ReadingPortStatusTask(String portName) {
