...
import com.kuz.tmp.old.controller.ProcessRunner;
...
public class MainUI extends javax.swing.JFrame {
    ...
    private final Logger logger = Logger.getLogger(MainUI.class); 
        ...
        try {
            ...
            for (int i = 0; r.next() && i < to; i++) {
                if (from <= i) {
                    ...
                    vector[0] = Util.formatPhoneNo(r.getString("phone_no"));
            ...
            logger.error("Error loading data, loadData() method", ex);
        }
    ...
    private void connectMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectMenuItemActionPerformed
        ...
        Object input = JOptionPane.showInputDialog(this, "Select COM port", "Connect", JOptionPane.PLAIN_MESSAGE, null, ComPortConnector.getInstance().getAvailableComports().toArray(), "");
        if (input != null) {
        ...
        if (MessageDialogBox.isConfirmed()) {
            for (int i : rows) {
                try {
                    ...
                    logger.error("Error loading data, deleteButtonActionPerformed() method", ex);
                }
            }
            removeAllRows();
    ...
    private void filterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_filterButtonActionPerformed
        ...
        try {
            ...
            logger.error("Error loading data, filterButtonActionPerformed() method", ex);
        }
        newerButton.setEnabled(false);
        olderButton.setEnabled(false);
            ...
            public void run() {
                ...
                while (true) {
                    try {
                        ...
                        logger.error("flashRow() method", ex);
                        return;
                    }
                }
                reColorRows();
            ...
            while (true) {
                ...
                try {
                    ...
                    try {
                        ...
                        logger.warn("DatabaseChangeListener stopped", ex);
                    }
                } catch (SQLException ex) {
                    logger.warn("DatabaseChangeListener", ex);          
                }
            }
        }
    }
